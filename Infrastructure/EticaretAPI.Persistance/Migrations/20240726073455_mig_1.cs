    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_ShopAssistants_ShopAssistantId",
                        column: x => x.ShopAssistantId,
                        principalTable: "ShopAssistants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProductProduct", x => new { x.OrdersId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_OrderProductProduct_OrderProducts_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "OrderProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderProductProduct_Product_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProductProduct_ProductsId",
                table: "OrderProductProduct",
                column: "ProductsId");
